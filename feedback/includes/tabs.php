	...
	<div class="card-body <?= $textRight; ?>">
		...
		<?php if (isset($_SESSION["seller_user_name"])) { ?>
			...
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link <?php if (!isset($_GET['comments'])) {
											echo "active";
										} ?>" data-toggle="tab" href="#ideas">Ideas</a>
				</li>
				<li class="nav-item">
					<a class="nav-link <?php if (isset($_GET['comments'])) {
											echo "active";
										} ?>" data-toggle="tab" href="#comments">Comments</a>
				</li>
			</ul>

			<div class="tab-content">
				<div id="ideas" class="tab-pane fade <?php if (!isset($_GET['comments'])) {
															echo "show active";
														} ?> mt-4">
					<?php
				...
				<div id="comments" class="tab-pane <?php if (isset($_GET['comments'])) {
														echo "show active";
													} ?> fade">
