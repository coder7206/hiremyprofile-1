			...
			<div class="modal-body p-0">
				...
				<div class="payment-options-list">
					<?php if ($enable_tazapay == "yes") { ?>
						<form action="<?= $site_url; ?>/conversations/checkout_order_tazapay" method="post" id="tazpay-form">
					...
					if ($enable_2checkout == "yes") {
						include("../plugins/paymentGateway/paym`entMethod2.php");
					}
					?>
...
<script src="<?= $site_url ?>/js/paypal.js" id="paypal-js" data-base-url="<?= $site_url; ?>" data-payment-type="message_offer">
</script>
