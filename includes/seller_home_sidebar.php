...
<div class="card card1 theme-bg font-weight-bold border-0 px-sm-4 px-2 py-3 d-flex align-items-center justify-content-space-between w-100 flex-row mb-4 text-largest ">
  <div class="row middle-border position-relative">
    <a class="col-6 py-2 text-white " href="<?= $site_url; ?>/requests/buyer_requests">Find Job</a>
    <a class="col-6 py-2 text-white" href="<?= $site_url; ?>/proposals/create_proposal">Post a Service</a>
    <a class="col-6 py-2 text-white" href="<?= $site_url; ?>/proposals/view_proposals">Start Selling</a>
    <a class="col-6 py-2 text-white" href="<?= $site_url; ?>/customer_support">Contact Support</a>
  </div>
</div>