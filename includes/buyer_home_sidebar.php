<div class="card card1 theme-bg text-white border-0 px-sm-4 px-2  py-3 w-100 mb-4">
  ...
  <div class="d-flex align-items-center justify-content-space-between">
    <h5><a class="text-white" href="">@<?= ucfirst($login_user_name); ?></a></h5>
...
<div class="card card1 theme-bg font-weight-bold border-0 px-sm-4 px-2 py-3 d-flex align-items-center justify-content-space-between w-100 flex-row mb-4 text-largest ">
  <div class="row middle-border position-relative">
    <a class="col-6 py-2 text-white " href="<?= $site_url; ?>/requests/post_request">Post a Job Free</a>
    <a class="col-6 py-2 text-white" href="<?= $site_url; ?>/search">Find a Service</a>
    <a class="col-6 py-2 text-white" href="<?= $site_url; ?>/freelancers">Hire an Expert</a>
    <a style="font-size: 16px; margin-top: 2px;" class="col-6 py-2 text-white" href="<?= $site_url; ?>/customer_support">Contact Support</a>
  </div>
</div>