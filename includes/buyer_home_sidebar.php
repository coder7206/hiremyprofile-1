...
<div id="seller-sidebar" style="<?= $activeTab == "buyer" ? "display: none" : "" ?>">
  <div class="card card1 background_site_color font-weight-bold border-0 px-sm-4 px-2 py-3 d-flex align-items-center justify-content-space-between w-100 flex-row mb-4">
    <div class="row">
      <div class="col restyling_div_alter">
        <a class="py-2 text-white " href="<?= $site_url; ?>/requests/buyer_requests" title="Find job">
          <i class="fa fa-search fafa-styleing" aria-hidden="true"></i><br>
          Find job
        </a>
      </div>
      <div class="col restyling_div_alter">
        <a class="py-2 text-white" href="<?= $site_url; ?>/proposals/create_proposal" title="Post a Service">
          <i class="fa fa-plus-square fafa-styleing" aria-hidden="true"></i><br>
          Post a Service
        </a>
      </div>
      <div class="w-100"></div>
      <div class="col restyling_div_alter">
        <a class="py-2 text-white" href="<?= $site_url; ?>/proposals/view_proposals" title="Start Selling">
...
<div id="seller-sidebar" style="<?= $activeTab == "buyer" ? "display: none" : "" ?>">
  <div class="card card1 theme-bg text-white border-0  px-sm-4 px-2  py-3 d-flex align-items-center justify-content-space-between w-100 flex-row bbw box-shadow-buyer1">
  ...
  <div class="card card1 theme-bg text-white border-0 mb-2 px-sm-4 px-2  py-3 d-flex align-items-center justify-content-space-between w-100 flex-row bbw box-shadow-buyer1">
  ...
  <div class="card card1 theme-bg text-white border-0 mb-2 px-sm-4 px-2  py-3 d-flex align-items-center justify-content-space-between w-100 flex-row bbw">
  ...
  <div class="card card1 theme-bg text-white border-0 px-sm-4 px-2  py-3 box-shadow-buyer1">
    <a class="text-white" href="<?= $site_url ?>/membership_subs">
      <div class="d-flex align-items-center justify-content-space-between">
