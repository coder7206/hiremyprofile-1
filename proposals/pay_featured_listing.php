	...
	<div class="modal-dialog">
		<div class="modal-content">
				...
				<div class="payment-options-list">
					...
					<?php if ($enable_paypal == "yes") { ?>
						<div class="payment-option">
							...
							<img src="<?=$site_url?>/images/paypal.png" class="img-fluid">
						</div>
					<?php } ?>
					<?php if ($enable_tazapay == "yes") { ?>
						<div class="payment-option">
							...
							<img src="<?=$site_url?>/images/tazapay.svg" class="img-fluid">
						</div>
					<?php } ?>
			...
			<div class="modal-footer">
				...
				<?php if($enable_tazapay == "yes"){ ?>
					<form action="<?=$site_url?>/tazapay_listing_charge" method="post" id="tazpay-form">
						<button class="btn btn-lg btn-success btn-block" type="submit" name="tazapay">
				...
				<?php if ($enable_paystack == "yes") { ?>
					<form action="paystack_listing_charge" method="post" id="paystack-form">
