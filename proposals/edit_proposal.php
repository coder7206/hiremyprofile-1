    ...
    <div class="row">
      ...
      <div class="col-xl-8 col-lg-10 col-md-12">
        ...
        <div class="tab-content card card-body">
          <!--- tab-content Starts --->
          <div class="tab-pane fade <?php if (!isset($_GET['video']) and !isset($_GET['instant_delivery']) and !isset($_GET['publish'])) {
                                      echo " show active";
                                    } ?>" id="overview">
            <?php include("sections/edit/overview.php"); ?>
          </div>
          <?php if ($videoPlugin == 1) { ?>
            <div class="tab-pane fade <?php if (isset($_GET['video'])) {
                                        echo "show active";
                                      } ?>" id="video">
              <?php include("../plugins/videoPlugin/proposals/sections/edit/video.php"); ?>
            </div>
          <?php } ?>
          <div class="tab-pane fade <?php if (isset($_GET['instant_delivery'])) {
                                      echo "show active";
                                    } ?>" id="instant-delivery">
          ...
          <?php if ($d_proposal_status == "draft") { ?>
            <div class="tab-pane fade <?php if (isset($_GET['publish'])) {
                                        echo "show active";
                                      } ?>" id="publish">
      ...
      function processOverViewRequest(form_data, status) {
        ...
        $.ajax({
          ...
          if (data == "error") {
            ...
            swal({
              type: 'warning',
              text: 'You Must Need To Add At Least 1 Image In Proposal To Continue.'
            });
