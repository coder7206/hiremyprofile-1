        ...
        <div class="tab-body p-3 pb-0 collapse" id="faq-<?= $id; ?>" data-parent="#faqTabs">
            ...
            <form action="" method="post" class="edit-faq">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="title" placeholder="Title" class="form-control form-control-sm" value="<?= $title; ?>" required minlength="20" maxlength="200">
                    <span class="text-dark d-block font-weight-light">min: 20 max: 200 <span class="pull-right"><i class="text-danger" id="faq-typed-characters"></i></span></span>
                </div>

                <div class="form-group mb-2">
                    <textarea name="content" rows="3" class="form-control form-control-sm" minlength="50" maxlength="500"><?= $content; ?></textarea>
                    <span class="text-dark d-block font-weight-light">min: 50 max: 500 <span class="pull-right"><i class="text-danger" id="faq-typed-characters"></i></span></span>
                </div>
...
<div class="tab">
    ...
    <div class="tab-body rounded border-1 p-3 pb-0 collapse" id="insert-faq" data-parent="#faqTabs">
        ...
        <form action="" method="post" class="add-faq">
            <div class="form-group mb-2">
                <input type="text" name="title" placeholder="Faq Title" class="form-control form-control-sm" required minlength="20" maxlength="200">
                <span class="text-dark d-block font-weight-light">min: 20 max: 200 <span class="pull-right"><i class="text-danger" id="faq-typed-characters"></i></span></span>
            </div>

            <div class="form-group mb-2">
                <textarea name="content" rows="3" placeholder="Faq Content" class="form-control form-control-sm" minlength="50" maxlength="500"></textarea>
                <span class="text-dark d-block font-weight-light">min: 50 max: 500 <span class="pull-right"><i class="text-danger" id="faq-typed-characters"></i></span></span>
            </div>
            <div class="form-group mb-0">
        ...
        function processAddFaq(form_data, status) {
            ...
            $.ajax({
                ...
                if (data == "error") {
                    ...
                    swal({
                        type: 'warning',
                        text: 'You Must Need To Fill Out All Fields Before Updating The Details.'
                    });
                    ...
                    $("#faqTabs").load("sections/edit/faqs", {
