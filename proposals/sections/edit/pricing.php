...
<script>
  $(document).ready(function() {
    ...
    $(".pricing-form").submit(function(event) {
      ...
      // var proposalPrice = form_data.get('proposal_price')
      // if (proposalPrice == 0) {
      //   validatePackages(form_data)
      // }
      $('#wait').addClass("loader");
      $.ajax({
        method: "POST",
    ...
    function validatePackages(data) {
      ...
      // var basic = data[1][description]
      var basic = data.get('proposal_packages[1][description]')
      alert(basic)
    }
