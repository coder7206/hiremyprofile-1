...
if (isset($_POST["proposal_id"])) {
	...
	if (isset($_POST['proposal_yt_url'])) {

		if (!empty($_POST['proposal_yt_url'])) {
			$decode = htmlspecialchars_decode($_POST['proposal_yt_url']);
			$data['proposal_yt_url'] = removeJava($decode, "<iframe>");
		}
	}
