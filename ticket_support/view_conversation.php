...
<body class="is-responsive">
  ...
  <div class="container pb-4" style="margin-top: 190px;">
    <!-- Container starts -->
            ...
            <div class="card-body">
              ...
              <form id="new_message" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <textarea placeholder="<?= $lang['placeholder']['enter_message']; ?>" class="form-control" name="new_message" id="new_message" rows="5" required></textarea>
                </div>
                <!--- form-group Ends --->
                <div class="form-group">
