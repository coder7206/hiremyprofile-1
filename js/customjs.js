$(document).ready(function(){
	...
	//	alert($this);
		...
		var followed_id = $(this).val();//$('#seller_id').attr("class");
		var follower_id = seller_id

		/*if($this == 'follow'){*/

			$.ajax({
				method: "POST",
				url: base_url+"/includes/following",
				data: {followed_id: followed_id, follower_id:follower_id }
			}).done(function(data){
		...
		/*var followed_id = $('#seller_id').attr("class");
		var follower_id = seller_id;
	...
	$("#unfollow").click(function(){
		...
		$.ajax({
			method: "POST",
			url: base_url+"/includes/unfollow",
			data: {followed_id: followed_id, follower_id:follower_id }
		}).done(function(data){
