                  ...
                  <tbody>
                     <tr>
                        <td width="100%" align="left" style="vertical-align:top">
                           <p class="heading">
                              مرحبا بك في
 <?= $site_name; ?>! قم بتأكيد بريدك الإلكتروني لإطلاق جميع الوظائف.
                                 ...
                                 <tr>
                                    ...
                                    <td align="left" style="vertical-align:middle" width="316">
                                       <p style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:21px;font-weight:700;color:#333333;margin:0px!important;padding:0px!important;line-height:20px">
                                          خدمات العقد
<br>
                                          <span style="font-size:16px;color:#888888;font-weight:300">استعن بالعاملين المستقلين الموهوبين لبدء مشروعك الاحترافي على طريقتك.
</span>
                                       </p>
                                    </td>
                                 </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left" style="vertical-align:middle" width="316">
                                       <p style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:21px;font-weight:700;color:#333333;margin:0px!important;padding:0px!important;line-height:20px">
                                          ابدأ بالبيع
                                          <br>
                                          <span style="font-size:16px;color:#888888;font-weight:300">انشر وابدأ في تقديم خدماتك على المنصة وكسبت المال.
</span>
                                       </p>
                                    </td>
                                 </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left" style="vertical-align:middle" width="316">
                                       <p style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:21px;font-weight:700;color:#333333;margin:0px!important;padding:0px!important;line-height:20px">
                                          كن حليفا<br>
                                          <span style="font-size:16px;color:#888888;font-weight:300">اربح المال عن طريق إعادة بيع خدمات المنصة المستقلة والإعلان عنها.</span>
                                       </p>
                                    </td>
                                 </tr>
                              </tbody>
