...
class Payment
{
  ...
  /// Tazapay Payment Code Starts ////
  function tazapay($data)
  {
    global $site_url;
    global $db;
    global $site_name;
    ...
    $t_url = $enable_tazapay_sandbox == 'yes' ? 'https://api-sandbox.tazapay.com' : 'https://app.tazapay.com';
    ...
    curl_setopt_array($curl, array(
      ...
      CURLOPT_POSTFIELDS => '{
          "buyer": {
              ...
              "business_name": "' . $login_seller_user_name . '"
          },
          "seller": {
    ...
    if (curl_errno($curl)) {
      ...
      $_SESSION['txn_no'] = $response['data']['txn_no'];
      $data['reference_no'] = $response['data']['txn_no'];
      $this->insert_temp_order($data, "", "tazapay");
  ...
  function tazapay_execute()
  {
    ...
    $reference_no = $_SESSION['txn_no'];
    unset($_SESSION['txn_no']);
    $this->execute_payment($reference_no, "tazapay");
  }
  /// Tazapay Payment Code Ends ////
