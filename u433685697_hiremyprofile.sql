...
--
-- Database: `u433685697_hiremyprofile`
--
...
(3, 3, 2, 17, 'wordpress', 'ftyut uyt yut iuyt iuyt utyi ytu uyg ygh8', '', '7 Days', '15', 'July 13, 2022', 'pending', 0),
...
(1, 'hiremyprofile.com', 1, 'Hiremyprofile', 'fevicon Image 2022-07-10 at 7.13.34 PM.png', 'image', '', 'WhatsApp Image 2022-06-24 at 5.42.20 PM.jpeg', 1, 'WhatsApp Image 2022-07-10 at 7.13.34 PM.jpeg', 'WhatsApp Image 2022-07-10 at 7.13.34 PM.jpeg', 0, 0, 0, 0, 'water mark 2022-07-10 at 7.13.34 PM copy.jpeg', '', '#00cedc', '#00cedc', '#00cedc', 'Hire my profile is a freelance market place, here you can Post  Free Projects &amp; Hire Top Freelancers. Here you can get  Professional support even after your work is done.', '..', '..', 'http://localhost/hiremyprofile', 'info@hiremyprofile.com', '© 2022- Preferred Outsourcing Pvt. Ltd', 'America/Chicago', 0, 0, '', '', '', '', '', 'no', '', '', '', '', '', 85, 10, 95, 25, 1, 1, 'yes', 0, 0, 'yes', '', 0, 'yes', 'yes', 'yes', 'yes', 1, '22', 'left', 'us', 'no', 0, 2, 1, '', 0, 0, '', '');
...
(2, 'test client', 'testclient', 'test@test.com', '', '+91 ', 0, '', '', 0, '', '$2y$10$gbUovS1RYqv1e16GdB45Kud9lkGhUEYr6nc3JaslLz9TGaX/h.u8O', '', '', 0, 0, 'India', '', '', '', 1, 0, 'July 04, 2022', 100, 8, 1650209321, '127.0.0.1', 'ok', 'off', '', '', 'July 03, 2022', 'yes', 1, '2022-09-16 03:49:51', 'Asia/Kolkata', 'online', '', 0, 0, 0, 0, 0, 0, 0),
(3, 'testseller ', 'testseller', 'testseller@123gmail.com', '', '+91 998989898923', 0, '', '', 0, '', '$2y$10$u8EiK.dfcNuyihi7Az4EWOLYiSHN/SfN5Nh7RBIC/2rQ4nqCVL3eu', '', '', 0, 0, 'India', 'ttest', '', '', 1, 1, 'September 05, 2022', 100, 10, 467610880, '127.0.0.1', 'ok', 'off', '', '', 'July 03, 2022', 'yes', 1, '2022-09-16 06:55:18', 'Asia/Kolkata', 'offline', '', 0, 0, 0, 0, 0, 0, 0),
(4, 'testseller1', 'testseller1', 'testseller@1234gmail.com', '', '+93 998989898923', 0, '', '', 0, '', '$2y$10$fKZNJlCJbZTDP5NmlH4.IebIu7hrWeisSfstMWYRAsft5GnSGkQUC', '', '', 0, 0, 'India', '', '', '', 1, 0, 'none', 0, 10, 1815194636, '59.89.18.216', 'ok', 'off', '', '', 'July 04, 2022', 'yes', 1, '2022-07-04 21:35:44', 'Asia/Kolkata', 'offline', '', 0, 0, 0, 0, 0, 0, 0),
...
--
ALTER TABLE `child_cats_meta`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6915;
...
--
ALTER TABLE `inbox_sellers`
  MODIFY `inbox_seller_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `instructions`
  MODIFY `instruction_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `proposals`
  MODIFY `proposal_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `proposal_packages`
  MODIFY `package_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `recent_proposals`
  MODIFY `recent_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `sellers`
  MODIFY `seller_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `seller_languages`
  MODIFY `language_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `skills_relation`
  MODIFY `relation_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
