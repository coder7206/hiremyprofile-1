        ...
        <div class="card-body details pt-0">
          <div class="proposal-info <?= ($lang_dir == "right" ? 'text-right' : '') ?>">
            ...
            for ($proposal_i = 0; $proposal_i < $proposal_rating; $proposal_i++) {
              echo " <img class='mb-1' src='" . $site_url . "/images/user_rate_full.png'> ";
            }
            for ($proposal_i = $proposal_rating; $proposal_i < 5; $proposal_i++) {
              echo " <img class='mb-1' src='" . $site_url . "/images/user_rate_blank.png'> ";
            }
            ?>
        ...
        <div class="card-header box-shadow-cheader">
          <h4 class="mb-0 <?= ($lang_dir == "right" ? 'text-right' : '') ?>">
            <div class="float-left">
              ...
              <?php
              for ($proposal_i = 0; $proposal_i < $proposal_rating; $proposal_i++) {
                echo " <img class='mb-2' src='" . $site_url . "/images/user_rate_full_big.png' > ";
              }
              for ($proposal_i = $proposal_rating; $proposal_i < 5; $proposal_i++) {
    ...
    <?php if (isset($_SESSION['seller_user_name'])) { ?>
      $(document).on("click", "#favorite_<?= $proposal_id; ?>", function(event) {
        ...
        $.ajax({
          ...
          success: function() {
            $("#favorite_<?= $proposal_id; ?>").attr({
              id: "unfavorite_<?= $proposal_id; ?>",
            });
      ...
      $(document).on("click", "#unfavorite_<?= $proposal_id; ?>", function(event) {
        ...
        $.ajax({
          ...
          success: function() {
            $("#unfavorite_<?= $proposal_id; ?>").attr({
              id: "favorite_<?= $proposal_id; ?>"
            });
