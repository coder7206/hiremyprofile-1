...
<?php require_once("includes/user_header.php") ?>
        ...
        <section class='content'>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4 bg-light text-center reg-sec-1 "><!--- col-lg-8 col-md-7 mb-3 Starts --->

                        <h2> Try Freelancer Membership</h2>
                        <p>
                            Designed to maximise your freelancers success and earnings! save upto 20% on annuel <br>
                            plans. Change plans anytime, condition apply see FAQ.
                        </p>
                ...
                <div class="row-fluid clearfix">
                    <div class="pricing-wrapper comparison-table clearfix style-3">
                        <div class="col-md-4 pricing-col list-feature">
                            <div class="pricing-card">
                                ...
                                <div class="pricing-feature">
                                    ...
                                    <li>
                                        <p> Select Type of Account - Business or Personal  </p>
                                    </li>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 pricing-col <?php if($plan_name=="Starter"){echo "person"; }elseif ($plan_name=="Basic One Month Trail"){echo "current unlim";}
                        else{echo "business"; }?>">
                            <div class="pricing-card">
                                <div class="pricing-header">
                                    <h5><?= $plan_name ?></h5>
                                    <div class="price-box">
                                        <div class="price"><?php if($plan_price_month == 0 ){echo "Free"; }else {echo $plan_price_month;} ?>
                                ...
                                <div class="pricing-feature">
                                    <li>
                                        <p>
                                            ...
                                            <i class="<?php if($create_active_service=="Yes"){echo "fa fa-check Available"; }elseif ($create_active_service=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?> "> <?php if($create_active_service=="Yes" || $create_active_service=="No"){echo "";}else{echo $create_active_service;}; ?> </i>
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <i class="<?php if($bids_per_month=="Yes"){echo "fa fa-check Available"; }elseif ($bids_per_month=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?> "> <?php if($bids_per_month=="Yes" || $bids_per_month=="No"){echo "";}else{echo $bids_per_month;}; ?> </i>
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <i class="<?php if($skills=="Yes"){echo "fa fa-check Available"; }elseif ($skills=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?> "> <?php if($skills=="Yes" || $skills=="No"){echo "";}else{echo $skills;}; ?> </i>
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <i class="<?php if($client_engagement=="Yes"){echo "fa fa-check Available"; }elseif ($client_engagement=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?> "> <?php if($client_engagement=="Yes" || $client_engagement=="No"){echo "";}else{echo $client_engagement;}; ?> </i>
                                        </p>
                                    </li>
                                    <li>
                                        <p>

                                            <i class="<?php if($daily_withdrawal_req=="Yes"){echo "fa fa-check Available"; }elseif ($daily_withdrawal_req=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?> "> <?php if($daily_withdrawal_req=="Yes" || $daily_withdrawal_req=="No"){echo "";}else{echo $daily_withdrawal_req;}; ?> </i>
                                        </p>
                                    </li>
                                    <li>
                                        <p>

                                            <i class="<?php if($employer_follow=="Yes"){echo "fa fa-check Available"; }elseif ($employer_follow=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?> "> <?php if($employer_follow=="Yes" || $employer_follow=="No"){echo "";}else{echo $employer_follow;}; ?> </i>
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <i class="<?php if($get_recom=="Yes"){echo "fa fa-check Available"; }elseif ($get_recom=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?> "> <?php if($get_recom=="Yes" || $get_recom=="No"){echo "";}else{echo $get_recom;}; ?> </i>
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <i class="<?php if($create_portfolio=="Yes"){echo "fa fa-check Available"; }elseif ($create_portfolio=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?>"> <?= $create_portfolio; ?> </i>
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                            <i class="<?php if($custome_desc=="Yes"){echo "fa fa-check Available"; }elseif ($custome_desc=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?>"> <?php if($custome_desc=="Yes" || $custome_desc=="No"){echo "";}else{echo $custome_desc;}; ?> </i>
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                            <i class="<?php if($referrals=="Yes"){echo "fa fa-check Available"; }elseif ($referrals=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?>"> <?php if($referrals=="Yes" || $referrals=="No"){echo "";}else{echo $referrals;}; ?> </i>
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                            <i class="<?php if($project_bookmark=="Yes"){echo "fa fa-check Available"; }elseif ($project_bookmark=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?>">  <?php if($project_bookmark=="Yes" || $project_bookmark=="No"){echo "";}else{echo $project_bookmark;}; ?> </i>
                                        </p>
                                    </li>
                                    <li>
                                        <p>

                                            <i class="<?php if($custom_cover_photo=="Yes"){echo "fa fa-check Available"; }elseif ($custom_cover_photo=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?>"> <?php if($custom_cover_photo=="Yes" || $custom_cover_photo=="No"){echo "";}else{echo $custom_cover_photo;}; ?> </i>
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <i class="<?php if($create_offer_coupon=="Yes"){echo "fa fa-check Available"; }elseif ($create_offer_coupon=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?>"> <?php if($create_offer_coupon=="Yes" || $create_offer_coupon=="No"){echo "";}else{echo $create_offer_coupon;}; ?> </i>
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <i class="<?php if($free_highlight_bids=="Yes"){echo "fa fa-check Available"; }elseif ($free_highlight_bids=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?>"> <?php if($free_highlight_bids=="Yes" || $free_highlight_bids=="No"){echo "";}else{echo $free_highlight_bids;}; ?></i>
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <i class="<?php if($account_type=="Yes"){echo "fa fa-check Available"; }elseif ($account_type=="No"){echo "fa fa-times unavailable";}
                                            else{echo "";}?>"> <?php if($account_type=="Yes" || $account_type=="No"){echo "";}else{echo $account_type;}; ?> </i>
                                ...
                                <div class="pricing-footer">
                                    <a href="<?= $site_url; ?>/plan_pyment.php?pid=<?= $plan_id;?>" class="btn btn-act rounded btn-line  <?php if($plan_price_month == 0){echo "disabled";} ?>">
                                        <span><?php if($plan_price_month == 0){echo "Activated";}else{echo "Order Now";} ?> </span>
                                ...
                                <div class="pricing-feature">
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <span style="font-weight: bold; color: #4a893e ">UNLIMITED</span>
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                    ...
                                    <li>
                                        <p>
                                            <b><span>Use Business logo</span></b>
                                        </p>
                                    </li>
                                    <li>
                                        <p>
...
-->
                ...
                <div class="row" style="padding-top: 15px">
                    <div class="col-md-12 mb-12 bg-light mb-12 reg-sec-1 " style="bottom: 40px"><!--- col-lg-8 col-md-7 mb-3 Starts --->
