...
<div class="form_for_pastexperience">
    ...
    <div class="main-experience-from">
        <form method="post" autocomplete="on">
            <div class="both-half">
                <div class="first-half">
                    <label for="job_title" class="col-md-12 pl-0">Title</label><br>
                    <input type="text" class="col-md-12" name="job_title" id="job_title" placeholder="Enter you job title"><br>
            ...
            <div class="d-flex w-100 py-3">
                <button type="submit" name="experience_add" id="experience_add">Submit</button>
            </div>
        </form>
    </div>
</div>
...
if (isset($_POST['portfolio_form'])) {
    ...
    // Debugging to check the uploaded images array
    echo "<pre>";
    print_r($uploadedImages);
    echo "</pre>";

    // Store data in database
    $portfolio = $db->insert("portfolios", array("project_title" => $projectTitle, "description" => $description, "seller_id" => $seller_id));
    ...
    <form id="portfolioForm" method="post" enctype="multipart/form-data">
        <div class="portfolio-from-div">
            ...
            <div class="portfolio-second">
                ...
                <input type="text" class="form-control col-md-12" id="projectskills" placeholder="Enter skills and press Enter">
        ...
        <div class="portfolio-from-div">
            ...
            <div class="portfolio-second">
                ...
                <input type="text" class="form-control col-md-12" id="videoUrl" placeholder="Enter video URL and press Enter">
