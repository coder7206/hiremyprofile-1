<div class="table-responsive box-table mt-3">
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			$sel_orders = $db->select("orders", array("buyer_id" => $login_seller_id, "order_active" => "yes"), "DESC");
	...
	if ($count_orders == 0) {
		echo "<center><h3 class='pb-4 pt-4'><i class='fa fa-meh-o'></i> {$lang['buying_orders']['no_active']}</h3></center>";
	}
