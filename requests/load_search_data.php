...
$select_proposals = $db->query("select DISTINCT proposal_child_id from proposals where proposal_seller_id <> '0'");
        ...
        if ($count_offers == 0) {
            ...
            <tr id="request_tr_<?= $request_id; ?>">
                ...
                <td>
                    ...
                    <?= $delivery_time; ?> <a href="#"
                                              class="remove-link remove_request_<?= $request_id; ?> text-success">
                        Remove Request </a>
                ...
                <td class="text-success font-weight-bold">
                    ...
                    <?php if ($login_seller_offers == "0") { ?>
                        ...
                        <button class="btn btn-success btn-sm mt-4 send_button_<?= $request_id; ?>" data-toggle="modal"
