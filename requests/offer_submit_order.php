         ...
         <div class="modal-footer">
            ...
            <?php if ($enable_tazapay == "yes") { ?>
               <form action="tazapay_charge" method="post" id="tazapay-form">
                  ...
                  <input name="tazapay" type="submit" class="btn btn-success" value="<?= $lang['button']['pay_with_tazapay']; ?>" />
...
<script src="<?= $site_url ?>/js/paypal.js" id="paypal-js" data-base-url="<?= $site_url; ?>" data-payment-type="request_offer">
</script>
   ...
   $(document).ready(function() {
      ...
      <?php if ($current_balance < $amount) { ?>
         <?php if ($enable_paypal == "yes") { ?>
            ...
            $('#coinpayments-form').hide();
            $('#paystack-form').hide();
         <?php } elseif ($enable_paypal == "no" and $enable_tazapay == "yes") { ?>
            $('#2checkout-form').hide();
            $('#coinpayments-form').hide();
            $('#mercadopago-form').hide();
            $('#mobile-money-form').hide();
