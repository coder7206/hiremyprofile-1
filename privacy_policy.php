    ...
    <div class="container-fluid mt-5 mb-5 pb-1 pt-5 site-theme-color">
        ...
        <di class="main_class_privacy">
            <div class="termandconditiondivside">
                <ul class="pl-1">
                    <a href="#one">
                        <li class="sidebar-list-details" title="The types of personal information we collect and hold">The types of personal info</li>
                    </a>
                    <a href="#two">
                        <li class="sidebar-list-details" title="How we collect personal information">How we collect personal info</li>
                    </a>
                    <a href="#three">
                        <li class="sidebar-list-details" title="We may request, collect, or process the following information">We may request, collect, </li>
                    </a>
                    <a href="#four">
                        <li class="sidebar-list-details" title="Information that we collect from others">Information that we collect </li>
                    </a>
                    <a href="#five">
                        <li class="sidebar-list-details" title="We may collect or process the following information">We may collect or process</li>
                    </a>
                    <a href="#six">
                        <li class="sidebar-list-details" title="Information we collect as you use our service">Information we collect as you</li>
                    </a>
                    <a href="#seven">
                        <li class="sidebar-list-details" title="We may collect or process the following information">We may collect or process</li>
                    </a>
                    <a href="#eight">
                        <li class="sidebar-list-details" title="Links to other sites">Links to other sites</li>
                    </a>
                    <a href="#nine">
                        <li class="sidebar-list-details" title="How we use personal information">How we use personal information</li>
                    </a>
                    <a href="#ten">
                        <li class="sidebar-list-details" title="Our third party service providers include">Our third party service providers</li>
                    </a>
                    <a href="#eleven">
                        <li class="sidebar-list-details" title="Other disclosures and transfers">Other disclosures and transfers</li>
                    </a>

                    <a href="#twelve">
                        <li class="sidebar-list-details" title="Exercising your other rights">Exercising your other rights</li>
                    </a>
                    <a href="#thirteen">
                        <li class="sidebar-list-details" title="You have the right to">You have the right to</li>
                    </a>
                    <a href="#fourteen">
                        <li class="sidebar-list-details" title="To contact our Privacy Officer">To contact our Privacy Officer</li>
                    </a>
                </ul>
            </div>
            <div class="termandconditiondivthird">
                ...
                <br>
                <h4 id="one">The types of personal information we collect and hold</h4>
                ...
                <br>
                <h4 id="two">How we collect personal information</h4>
                ...
                <br>
                <h4 id="three">We may request, collect, or process the following information:</h4>
                ...
                <br>
                <h4 id="four">Information that we collect from others</h4>
                <ul>
                ...
                <br>
                <h4 id="five">We may collect or process the following information:</h4>
                <ol style="list-style-type: none;">
                ...
                <h4 id="six">Information we collect as you use our service</h4>
                ...
                <br>
                <h4 id="seven">We may collect or process the following information:</h4>
                ...
                <h4 id="eight">Links to other sites</h4>
                ...
                <br>
                <h4 id="nine">How we use personal information</h4>
                ...
                <br>
                <h4 id="ten">Our third party service providers include:</h4>
                <ol>
                ...
                <br>
                <h4 id="eleven">Other disclosures and transfers</h4>
                ...
                <br>
                <h4 id="twelve">Exercising your other rights</h4>
                ...
                <h4 id="thirteen">You have the right to:</h4>
                <ol>
                ...
                <br>
                <h5 id="fourteen">To contact our Privacy Officer</h5>
