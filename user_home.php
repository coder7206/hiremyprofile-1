...
<div class="about-section-1 container-fluid pt-5">
  <div class="row">
    <div class="user_border buyer_box col-xl-3 col-lg-4 <?=($lang_dir == "right" ? 'order-2 order-sm-1':'')?>">
      <?php include("includes/buyer_home_sidebar.php"); ?>
    </div>
    <div class="user_border seller_box hide col-xl-3 col-lg-4 <?=($lang_dir == "right" ? 'order-2 order-sm-1':'')?>">
      <?php include("includes/seller_home_sidebar.php"); ?>
    </div>

    <div class="col-xl-9 col-lg-8 pb-5">
      <div class="nav nav-tabs font-weight-bold text-largest" id="nav-tab" role="tablist">
        <a class="nav-item nav-link active" data-toggle="tab" href="#Buyer" role="tab" aria-selected="true" id="buyer_tab">Buyer </a>
        <a class="nav-item nav-link" data-toggle="tab" href="#Seller" role="tab" aria-selected="false" id="seller_tab">Seller</a>
      </div>
      <div class="pt-5">
        ...
        <div class="row buyer_tab">
          <?php
            $instructions = $db->query("select * from instructions where instruction_for=1");
            $i = 1;
            while($instruction = $instructions->fetch()){?>
              <div class="col-md-6 pt-5">
                <div class="d-flex">
                  <div class="pr-5">
                    <i class="fa <?= $instruction->instruction_icon; ?> fa-3x <?= $instruction->instruction_color_code; ?>"></i>
                  </div>
                  <div>
                    <h3><?= $i;?>) <?= $instruction->instruction_title; ?></h3>
                    <p><?= $instruction->instruction_desc; ?></p>
                  </div>
                </div>
              </div>
            <?php $i++; } ?>
        </div>
        <div class="row seller_tab hide">
          <?php
            $instructions = $db->query("select * from instructions where instruction_for=1");
            $i = 1;
            while($instruction = $instructions->fetch()){?>
  ...
  <div class="tab-pane fade show active" id="Buyer" role="tabpanel">
    <div class="about-section-2 pt-5">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12 mt-5 mb-3"><h1 class="pull-left"> <?= $lang['sidebar']['recently_viewed']; ?> </h1></div>
                          ...
                          <div class="card-body">
                            <div class="d-flex">
                              ...
                              <div class="px-3 d-flex justify-content-between w-100 align-items-center">
                                <div class="">
                                  <a href="<?= $site_url; ?>/<?= $seller_user_name; ?>" class="seller-name"><h5 class="card-title font-weight-bold mb-0"><?= $seller_user_name; ?></h5></a>
        ...
        <!-- Buy again Start -->
        <div class="row">
          <div class="col-md-12 mt-5 mb-3"><h1 class="pull-left"> Buy again from your favorite sellers </h1></div>
    ...
    <div class="about-section-2 pt-5">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <?php include('proposals/user_view_proposal.php'); ?>
        </div>
        <!-- End Proposal -->
        <!-- Buyer Contacts -->
        <div class="row">
