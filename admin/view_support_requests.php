                        ...
                        <div class="d-flex justify-content-center"><!--- d-flex justify-content-center Starts --->
                            ...
                            <ul class="pagination"><!--- pagination Starts --->
                                ...
                                for (; $i < min($page + 6, $total_pages); $i++) {
                                    ...
                                    echo "'><a href='index?view_support_requests=" . $i . "&enquiry_id=$enquiry_search&search=$search' class='page-link'>" . $i . "</a></li>";
                                }
                                ...
                                if ($total_pages > 1) {
                                    echo "<li class='page-item " . ($total_pages == $page ? "active" : "") . "'><a class='page-link' href='index?view_support_requests=$total_pages&enquiry_id=$enquiry_search&search=$search'>$total_pages</a></li>";
                                }
