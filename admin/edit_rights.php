...
<div class="col-md-6 bg-white">
    ...
    <div class="checkbox">
      <label>
      <input type="checkbox" name="videos" <?php if($a_videos == 1){ echo "checked"; } ?> value="1">Videos
      </label>
    </div>
    <div class="checkbox">
      <label>
      <input type="checkbox" name="instruction" <?php if($a_instruction == 1){ echo "checked"; } ?> value="1">Instruction
      </label>
    </div>
</div>
