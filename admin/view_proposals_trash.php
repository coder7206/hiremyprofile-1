        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1><i class="menu-icon fa fa-table"></i> Proposals / Trash</h1>
                </div>
            </div>
        </div>
        <div class="col-sm-8">
                        ...
                        <div class="table-responsive mt-4">
                            ...
                            <table class="table  table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $get_proposals = $db->query("select * from proposals where proposal_status='trash' order by 1 DESC");
                            ...
                            <?php if ($count_trash_proposals == 0) {
                                ...
                                echo "<center><h3 class='pt-3 pb-3'> Currently no Proposals in the trash</h3></center>";
                            }
