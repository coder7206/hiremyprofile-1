...
if (!isset($_SESSION['admin_email'])) {
    ...
    $subheader_tagline = $row_general_settings->subheader_tagline;
...
?>
    ...
    <div class="container">
                    ...
                    <div class="card-body"><!--- card-body Starts --->
                        ...
                        <form method="post" enctype="multipart/form-data"><!--- form Starts --->
                            ...
                            <div class="form-group row"><!--- form-group row Starts --->
                                ...
                                <label class="col-md-3 control-label"> Sub header tagline: </label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="enable_mobile_logo" class="form-control" required="">
                                        ...
                                        <option value="0" <?= ($enable_mobile_logo == 0) ? "selected" : ""; ?>> No
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" required=""><!--- form-group row Starts --->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="form-text text-muted">Enable or disable referrals on the website.
                                    </small>
                                </div>
                            </div><!--- form-group row Ends --->
                            ...
                            <div class="form-group row"><!--- form-group row Starts --->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="form-text text-muted">Enable or disable knowledge bank popup on the
                                        website.
                                    </small>
                                </div>
                            </div><!--- form-group row Ends --->
                        ...
                        <form method="post" enctype="multipart/form-data"><!--- form Starts --->
                            ...
                            <div class="form-group row"><!--- form-group row Starts --->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="form-text text-muted"> It will prevent users from adding video from
                                        their to computer to proposal video.
                                    </small>
                                </div>
                            </div><!--- form-group row Ends --->

                            <div class="form-group row"><!--- form-group row Starts --->
                                <label class="col-md-3 control-label"> Enable edited proposals to be submitted for
                                    approval : </label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row"><!--- form-group row Starts --->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="form-text text-muted">When enabled (yes) each time a user publishes a
                                        proposal, admin will be notified.
                                    </small>
                                </div>
                            </div><!--- form-group row Ends --->
        ...
        if (isset($_POST['general_settings_update'])) {
            ...
            $subheader_tagline = $input->post('subheader_tagline');
            ...
            if (!in_array($favicon_extension, $allowed) & !empty($site_favicon) or !in_array($logo_extension, $allowed) & !empty($site_logo) or !in_array($logo_image_extension, $allowed) & !empty($site_logo_image)) {
                ...
                $update_general_settings = $db->update("general_settings", array(
                    ...
                    "site_desc" => $site_desc,
                    "subheader_tagline" => $subheader_tagline,
