...
if (!isset($_SESSION['admin_email'])) {
    ...
    if ($_GET['view_support_requests_closed']) {
                        ...
                        <div class="table-responsive mt-4"><!--- table-responsive mt-4 Starts --->
                            ...
                            <table class="table table-bordered links-table"><!--- table table-bordered table-hover links-table Starts --->
                                ...
                                <tbody><!--- tbody Starts --->
                                    ...
                                    // $get_support_tickets = $db->query("select * from support_tickets where enquiry_id=:enquiry_id AND status!='open'", [":enquiry_id" => $enquiry_id])->rowCount();
                        ...
                        <div class="d-flex justify-content-center"><!--- d-flex justify-content-center Starts --->
                            ...
                            <ul class="pagination"><!--- pagination Starts --->
                                ...
                                for (; $i < min($page + 6, $total_pages); $i++) {
                                    ...
                                    echo "'><a href='index?view_support_requests_closed=" . $i . "&enquiry_id=$enquiry_search&search=$search' class='page-link'>" . $i . "</a></li>";
                                }
                                ...
                                if ($total_pages > 1) {
                                    echo "<li class='page-item " . ($total_pages == $page ? "active" : "") . "'><a class='page-link' href='index?view_support_requests_closed=$total_pages&enquiry_id=$enquiry_search&search=$search'>$total_pages</a></li>";
                                }
