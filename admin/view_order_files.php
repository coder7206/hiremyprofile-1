...
?>
    ...
    <div class="breadcrumbs">
        ...
        <div class="col-sm-8">
            ...
            <option data-url="index?view_order_files" selected="">Local Server</option>
            
            <option data-url="index?view_s3_order_files">AWS S3</option>
    ...
    ?>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
            ...
            <div class="card">
                ...
                if(exif_imagetype('../order_files/' . $files_array[$i]) == IMAGETYPE_JPEG or  exif_imagetype('../order_files/' . $files_array[$i]) == IMAGETYPE_PNG or exif_imagetype('../order_files/' . $files_array[$i]) == IMAGETYPE_GIF){

                ?>

                <img src="../order_files/<?= $files_array[$i]; ?>" class="img-fluid">
                ...
                <a href="../order_files/<?= $files_array[$i]; ?>" download class="float-left">
...
<div class="row"><!--- 3 row Starts --->
    ...
    <div class="col-lg-12"><!--- col-lg-12 Starts --->
        ...
        echo "
        <li class='page-item'>
            <a href='index?view_order_files=1' class='page-link'> First Page </a>
        </li>";
        ...
        for($i=1; $i<=$total_pages; $i++){
            ...
            echo "'>
                <a href='index?view_order_files=".$i."' class='page-link'>".$i."</a>
            </li>";
        ...
        echo "
        <li class='page-item'>
            <a href='index?view_order_files=$total_pages' class='page-link'> Last Page </a>
        </li>";
