    ...
    <div class="card-body"><!--- card-body Starts --->
        <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
            <div class="form-group row"><!--- form-group row Starts --->
                ...
                <div class="col-md-6">
                    <input type="text" name="slide_name" class="form-control" value="<?= $s_name; ?>">
                </div>
            </div><!--- form-group row Ends --->
            <div class="form-group row"><!--- form-group row Starts --->
                <label class="col-md-3 control-label"> Slide Description : </label>
                <div class="col-md-6">
                    <textarea name="slide_desc" class="form-control"><?= $s_desc; ?></textarea>
                </div>
            </div><!--- form-group row Ends --->
            <div class="form-group row"><!--- form-group row Starts --->
                ...
                <div class="col-md-6">
                    ...
                    <?php if($s_extension == "mp4" or $s_extension == "webm" or $s_extension == "ogg"){ ?>
                      <video width="300" height="180" controls>
                        <source src="<?= getImageUrl("slider",$s_image); ?>" type="video/mp4">
                      </video>
                    <?php }else{ ?>
                      <br>
                      <img src="<?= getImageUrl("slider",$s_image); ?>" width="100" height="40">
                    <?php } ?>
                    <br>
            ...
            <div class="form-group row"><!--- form-group row Starts --->
                ...
                <div class="col-md-6">
                    <input type="text" name="slide_url" class="form-control" value="<?= $s_url; ?>">
                </div>
            </div><!--- form-group row Ends --->
...
if(isset($_POST['update'])){
   ...
   // }else{
      ...
      if(!in_array($file_extension,$allowed) & !empty($slide_image)){
         ...
         if($update_slide){
            $insert_log = $db->insert_log($admin_id,"video",$edit_id,"updated");
