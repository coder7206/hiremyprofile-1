        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1><i class="menu-icon fa fa-table"></i> Proposals / Paused Proposals</h1>
                </div>
            </div>
        </div>
        <div class="col-sm-8">
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li class="active">Paused Proposals</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a title="View Proposal" href="../proposals/<?= $seller_user_name; ?>/<?= $proposal_url; ?>" target="_blank">
                                                    ...
                                                    <i class="fa fa-eye"></i> Preview Proposal
                            ...
                            if ($count_pause_proposals == 0) {

                                echo "<center><h3 class='pt-3 pb-3'>No Proposals paused at the momment</h3></center>";
                            }
