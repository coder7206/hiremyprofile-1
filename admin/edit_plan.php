...
?>
        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1><i class="menu-icon fa fa-picture-o"></i> Edit Plan </h1>
                </div>
            </div>
        </div>
        <div class="col-sm-8">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input type="text" class="form-control" name="plan_name" value="<?= $plan_name; ?>" id="plan_name" placeholder="Plan Name" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="create_active_service" value="<?= $create_active_service; ?>" class="form-control" id="create_active_service" placeholder="Create Active Service" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="bids_per_month">Bids Per Month:</label>
                                    <input type="number" class="form-control" name="bids_per_month"  value="<?= $bids_per_month; ?>" id="bids_per_month" placeholder="Bids Per Month" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="skills" value="<?= $skills; ?>" class="form-control" id="skills" placeholder="No. of Skills" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="client_engagement" class="col-12">Client Engagement:</label>
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="client_engagement" id="client_engagement" value="No" <?= $client_engagement == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="client_engagement">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="client_engagement" id="client_engagement1" value="Yes" <?= $client_engagement == "Yes" ? "checked" : "" ; ?> required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="daily_withdrawal_req" id="daily_withdrawal_req" value="No" <?= $daily_withdrawal_req == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="daily_withdrawal_req">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="daily_withdrawal_req" id="daily_withdrawal_req1" value="Yes" <?= $daily_withdrawal_req == "Yes" ? "checked" : "" ; ?> required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="employer_follow" id="employer_follow" value="No" <?= $employer_follow == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="employer_follow">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="employer_follow" id="employer_follow1" value="Yes" <?= $employer_follow == "Yes" ? "checked" : "" ; ?> required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" step="any" name="percentage_per_project" value="<?= $percentage_per_project; ?>" class="form-control" id="percentage_per_project" placeholder="Percentage Per Project" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="get_recom" class="col-12">Get Recommendation:</label>
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="get_recom" id="get_recom" value="No" <?= $get_recom == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="get_recom">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="get_recom" id="get_recom1" value="Yes" <?= $get_recom == "Yes" ? "checked" : "" ; ?> required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="create_portfolio" id="create_portfolio" value="No" <?= $create_portfolio == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="create_portfolio">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="create_portfolio" id="create_portfolio1" value="Yes" <?= $create_portfolio == "Yes" ? "checked" : "" ; ?> required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="custome_desc" id="custome_desc" value="No" <?= $custome_desc == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="custome_desc">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="custome_desc" id="custome_desc1" value="Yes" <?= $custome_desc == "Yes" ? "checked" : "" ; ?> required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="referrals" id="referrals" value="No" <?= $referrals == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="referrals">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="referrals" id="referrals1" value="Yes" <?= $referrals == "Yes" ? "checked" : "" ; ?> required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="project_bookmark" value="<?= $project_bookmark; ?>" class="form-control" id="project_bookmark" placeholder="Project Bookmarks (No, Unlimited, Number)" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="custom_cover_photo" id="custom_cover_photo" value="No" <?= $custom_cover_photo == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="custom_cover_photo">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="custom_cover_photo" id="custom_cover_photo1" value="Yes" <?= $custom_cover_photo == "Yes" ? "checked" : "" ; ?> required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="create_offer_coupon" id="create_offer_coupon" value="No" <?= $create_offer_coupon == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="create_offer_coupon">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="create_offer_coupon" id="create_offer_coupon1" value="Yes" <?= $create_offer_coupon == "Yes" ? "checked" : "" ; ?> required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="free_highlight_bids" value="<?= $free_highlight_bids; ?>" class="form-control" id="free_highlight_bids" placeholder="Free Highlighted Bids (No, Yes, Number)" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="hide_project_others" class="col-12">Hide Project Offer for Other Freelancers:</label>
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="hide_project_others" id="hide_project_others" value="No" <?= $hide_project_others == "No" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="hide_project_others">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="hide_project_others" id="hide_project_others1" value="Yes" <?= $hide_project_others == "Yes" ? "checked" : "" ; ?> required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" step="any" name="plan_price_month" value="<?= $plan_price_month; ?>" class="form-control" id="plan_price_month" placeholder="Plan Price Month" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="plan_discount_month">Discount on Plan/Month:</label>
                                    <input type="number" step="any" name="plan_discount_month" value="<?= $plan_discount_month; ?>" class="form-control" id="plan_discount_month" placeholder="Discount on Plan/Month" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" step="any" name="plan_price_annuel" value="<?= $plan_price_annuel; ?>" class="form-control" id="plan_price_annuel" placeholder="Plan Price Annual" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="plan_discount_annuel">Discount on Plan/Annual:</label>
                                    <input type="number" step="any" name="plan_discount_annuel" value="<?= $plan_discount_annuel; ?>" class="form-control" id="plan_discount_annuel" placeholder="Discount on Plan/Month" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="account_type" id="account_type" value="Business" required <?= $account_type == "Business" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="account_type">Business</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="account_type" id="account_type1" value="Personal" required <?= $account_type == "Personal" ? "checked" : "" ; ?> required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="plan_status" id="plan_status" value="Active" required <?= $plan_status == "Active" ? "checked" : "" ; ?> required>
                                            <label class="form-check-label" for="plan_status">Active</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="plan_status" id="plan_status1" value="Dective" required <?= $plan_status == "Dective" ? "checked" : "" ; ?> required>
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_plan = $db->update("membership_table", array(
