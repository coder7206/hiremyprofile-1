...
if($_GET['view_inbox_files']){
    
$page = $_GET['view_inbox_files'];
    ...
    ?>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
            ...
            <div class="card">
                ...
                <img src="../conversations/conversations_files/<?= $files_array[$i]; ?>" class="img-fluid">
                ...
                <a href="../conversations/conversations_files/<?= $files_array[$i]; ?>" download class="float-left">

                <i class="fa fa-download"></i> Download

                </a>

                <a href="index?delete_inbox_file=<?= $files_array[$i]; ?>" class="float-right">
...
<div class="row"><!--- 3 row Starts --->
    ...
    <div class="col-lg-12"><!--- col-lg-12 Starts --->
        ...
        echo "
        <li class='page-item'>
            <a href='index?view_inbox_files=1' class='page-link'> First Page </a>
        </li>";
        ...
        for($i=1; $i<=$total_pages; $i++){
            ...
            echo "'>
                <a href='index?view_inbox_files=".$i."' class='page-link'>".$i."</a>
            </li>";
        ...
        echo "
        <li class='page-item'>
            <a href='index?view_inbox_files=$total_pages' class='page-link'> Last Page </a>
        </li>";
