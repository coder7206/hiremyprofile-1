...
if ($a_m_plan == 1) {
	...
	if (isset($_GET['membership_plans'])) {
		include("view_plan.php");
	}
	if (isset($_GET['add_new_plan'])) {
...
if ($a_instruction == 1) {
	if (isset($_GET['insert_instruction'])) {
		include("insert_instruction.php");
	}
	if (isset($_GET['view_instructions'])) {
		include("view_instructions.php");
	}
	if (isset($_GET['delete_instruction'])) {
		include("delete_instruction.php");
	}
