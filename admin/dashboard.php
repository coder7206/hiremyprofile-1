                    ...
                    <div class="card-body">
                        <div class="mx-auto d-block">
                            <?php if (!empty($admin_image)) { ?>
                                <img class="img-thumbnail rounded-circle mx-auto d-block" src="<?= getImageUrl("admins", $admin_image); ?>" alt="Card image cap" width="145px">
                            <?php } else { ?>
                                <img class="img-thumbnail rounded-circle mx-auto d-block" src="admin_images/empty-image.png" alt="Empty image" width="145px">
                            <?php } ?>
