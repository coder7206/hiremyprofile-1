        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-5">
                ...
                <div class="card-header">
                    <!--- card-header Starts --->
                    <h4 class="h4">
                        <i class="fa fa-credit-card"></i> Taza Pay
                    </h4>
                </div>
                <!--- card-header Ends --->
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            <!--- form-group row Starts --->
                            <label class="col-md-3 control-label"> Enable Taza Pay: </label>
                            <div class="col-md-6">
                                <select name="tazapay" class="form-control" required="">
                                    <?php if($enable_tazapay == "yes"){ ?>
                                        <option value="yes"> Yes </option>
                                        <option value="no"> No </option>
                                    <?php }elseif($enable_tazapay == "no"){ ?>
                                        <option value="no"> No </option>
                                        <option value="yes"> Yes </option>
                                    <?php } ?>
                                </select>
                                <small class="form-text text-muted">Allow buyers to pay with Taza Pay</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            <!--- form-group row Starts --->
                            <label class="col-md-3 control-label">Tazapay Sandbox: </label>
                            <div class="col-md-6">
                                <select name="tazapay_sandbox" class="form-control" required="">

                                        <option value="yes" <?php if($enable_tazapay_sandbox == "yes"){ echo "selected"; }?>> Yes </option>
                                        <option value="no" <?php if($enable_tazapay_sandbox == "no"){ echo "selected"; }?>> No </option>
                        ...
                        <div class="form-group row">
                            <!--- form-group row Starts --->
                            <label class="col-md-3 control-label"> Tazapay Secret Key : </label>
                            <div class="col-md-6">
                                <input type="text" name="tazapay_secret" class="form-control" value="<?= $enable_tazapay_secret; ?>">
                            </div>
                        </div>
                        <!--- form-group row Ends --->

                        <div class="form-group row"><!--- form-group row Starts --->
                            <label class="col-md-3 control-label"> Tazapay Access Key : </label>
                            <div class="col-md-6">
                                <input type="text" name="tazapay_access" class="form-control" value="<?= $enable_tazapay_access; ?>">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 control-label"></label>
                            <div class="col-md-6">
                                <input type="submit" name="update_tazapay_settings" class="btn btn-success form-control" value="Update Tazapay Settings">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                    </form>
...
<?php
  ...
  if(isset($_POST['update_tazapay_settings'])){
    $data = $input->post();
    unset($data['update_tazapay_settings']);
    $update_tazapay_settings = $db->update("payment_settings",$data);
    if($update_tazapay_settings){
      $insert_log = $db->insert_log($admin_id,"tazapay","","updated");
      echo "<script>alert_success('Tazapay Settings Updated Successfully!','index?payment_settings');</script>";
    }
  }
