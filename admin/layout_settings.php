...
if(!isset($_SESSION['admin_email'])){
  ...
  $get_section_5 = $db->select("home_section_5",array("language_id" => $adminLanguage));
  $row_section_5 = $get_section_5->fetch();
  $count_section_5 = $get_section_5->rowCount();
  @$db_section_heading_5 = $row_section_5->section_heading;
  @$db_section_short_heading_5 = $row_section_5->section_short_heading;
  @$db_section_video_url_5 = $row_section_5->video_url;
...
if(isset($_POST['update_section'])){
  ...
  $section_heading_1 = $input->post('section_title_1');
  $section_short_heading_1 = $input->post('editor1');
  $section_video_url = $input->post('section_video_url');
  if($count_section_5 == 1){
    $update_section = $db->update("home_section_5",array("section_heading" => $section_heading_1,"section_short_heading" => $section_short_heading_1,"video_url" => $section_video_url),array("language_id" => $adminLanguage));
  }else{
    $update_section = $db->insert("home_section_5",array("language_id" => $adminLanguage,"section_heading" => $section_heading_1,"section_short_heading" => $section_short_heading_1,"video_url" => $section_video_url));
  }

  if($update_section){
    $insert_log = $db->insert_log($admin_id,"home_section","","updated");
    $insert_log = $db->insert_log($admin_id,"home_section_5","","updated");
...
<div class="row"><!--- 4 row Starts --->
  <div class="col-lg-12"><!--- col-lg-12 Starts --->
    <div class="card"><!--- card Starts --->
      <div class="card-header"><!--- card-header Starts --->
        <h4 class="h4">
          <i class="fa fa-home fa-fw"></i>  Home Page Section 5
          <small class="text-muted">
            This section is located on the cover photo(s) on landing page
          </small>
        </h4>
      ...
      <div class="card-body"><!--- card-body Starts --->
        <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
          <div class="form-group row"><!--- form-group row Starts --->
            ...
            <div class="col-md-6">
              <input type="text" name="section_title_1" class="form-control" value="<?= $db_section_heading_5; ?>" required="">
            </div>
          </div><!--- form-group row Ends --->
          <div class="form-group row"><!--- form-group row Starts --->
            <label class="col-md-3 control-label"> Section HTML : </label>
            <div class="col-md-6">
              <!-- <input type="text" name="section_short_heading" class="form-control" value="<?= $db_section_short_heading; ?>" required=""> -->
              <textarea name="editor1"><?= $db_section_short_heading_5; ?></textarea>

            </div>
          </div><!--- form-group row Ends --->
          <div class="form-group row"><!--- form-group row Starts --->
            <label class="col-md-3 control-label"> Section Video URL : </label>
            <div class="col-md-6">
              <input type="text" name="section_video_url" class="form-control" value="<?= $db_section_video_url_5; ?>" required="">
            </div>
          </div><!--- form-group row Ends --->
          <div class="form-group row"><!--- form-group row Starts --->
            <label class="col-md-3 control-label"></label>
