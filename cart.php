...
<body class="is-responsive">
	...
	<div class="container mb-5">
		<div class="row padding-alter14">
			<div class="col-md-12">
				<div class="card mb-3">
					<div class="card-body">
						<h5 class="float-left mt-1"> <?= $lang['cart']['your_cart']; ?> (<?= $count_cart; ?>) </h5>
		...
		<div class="row cart-add-sect padding-alter14a" id="cart-show">
			<div class="col-md-7">
				<div class="card mb-3">
					<div class="card-body">
						<?php
						...
						<?php } ?>
						<h3 class="float-right color mb-0"><?= $lang['cart']['total']; ?> <?= showPrice($total); ?> </h3>
					</div>
				</div>
				<?php
				if ($count_cart == 0) {
					echo "<center><h3 class='pt-5 mb-3'><i class='fa fa-meh-o'></i> Your cart is empty</h3></center>";
				}
				?>
			</div>
			<div class="col-md-5">
				<div class="card">
					<div class="card-body cart-order-details">
						<p>
							<?= $lang['cart']['subtotal']; ?> <span class="float-right color mb-0"><?= showPrice($total); ?></span>
						</p>
						<hr>
						...
						<p>
							...
							<span class="float-right color mb-0"><?= showPrice($processing_fee); ?></span>
						</p>
						<hr>
						<p>
							<?= $lang['cart']['total2']; ?>
							<span class="font-weight-bold float-right color mb-0"><?= showPrice($total + $processing_fee); ?></span>
						</p>
						<hr>
						<?php if ($count_cart == 0) { ?>
							<h5 class="text-center no-border"> <?= $lang['cart']['no_proposals']; ?> </h5>
						<?php } else { ?>
